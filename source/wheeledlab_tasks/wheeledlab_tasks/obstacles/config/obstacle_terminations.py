"""Termination functions for the obstacle task."""
...
from .obstacle_rewards import forward_vel, upright_penalty
...
@configclass
class ObstacleTerminationsCfg:
    """Termination terms for obstacle navigation."""
